...
@WebServlet("/soj_inout_q")
public class soj_inout_q extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch(sActGubun) {
             case "R":	//조회
                 ...
                 iLength = 10;
                 sPageLength = "20";
                 response.getWriter().write(getJson(sPage,sPageLength,sFdate,sTdate,sCvcod,sItnbr,sItdsc,sSaupj));
                 break;            
             case "Rs": // 테이블 헤더
    ...
    public String getJson(String sPage, String sPageLength, String sFdate, String sTdate, String sCvcod,
            String sItnbr, String sItdsc, String sSaupj) throws IOException{
        ...
        JSONObject joListData = null;
        joListData = startSelect(sFdate, sTdate, sCvcod, sItnbr, sItdsc, sSaupj);     
    ...
    //현황 조회
    public JSONObject startSelect(String sFdate, String sTdate, String sCvcod, String sItnbr, String sItdsc, String sSaupj) {
        String sResult = null;
...
//        		+ "       decode(Z.OUTSIDE_IN, 'Y', H.IOQTY  * Z.CALVALUE,  0) AS IPGO, "
//        		+ "       decode(Z.OUTSIDE_OUT, 'Y', H.IOQTY * Z.CALVALUE, 0) AS CHUL, "
...
//        		+ "       DECODE(I.ISPEC_CODE,NULL,I.JIJIL,I.JIJIL||'-'||I.ISPEC_CODE) AS JIJIL, "
        		...
        		+ "       fun_danmst_waiju_jaje( H.ITNBR, H.CVCOD, TO_CHAR(SYSDATE,'YYYYMMDD')) AS DANGA, "
        		+ "       H.SAUPJ "
        		...
        		+ "		 	  H.IOGBN = Z.IOGBN	 AND "
        		+ "           H.SAUPJ = ? ";
//        		+ "	      	( Z.OUTSIDE_IN = 'Y' OR Z.OUTSIDE_OUT = 'Y') ";
