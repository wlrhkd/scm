 ...
 */
@WebServlet("/comm_login_f")
public class comm_login_f extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        comm_login_f_DAO dbDAO = new comm_login_f_DAO();
        ...
        switch (sSearchGubun) {
            case "login":
                ...
                sListData = dbDAO.getLoginList(sPage,sCheckGubun,sSearchValue); //업체리스트
