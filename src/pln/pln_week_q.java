...
@WebServlet("/pln_week_q")
public class pln_week_q extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch(sActGubun) {
             case "R":	//조회
                 ...
                 iLength = 10;
                 sPageLength = "20";
                 response.getWriter().write(getJson(sPage,sPageLength,sYymd,sCvcod,sSaupj,sItnbr,sItdsc));
                 break;                     
             case "Rs": // 테이블 헤더
    ...
    public String getJson(String sPage, String sPageLength, String sYymd, String sCvcod,
        ...
        JSONObject joListData = null;
        joListData = startSelect(sYymd, sCvcod, sSaupj, sItnbr, sItdsc);     
    ...
    //주간 납품계획 조회
    public JSONObject startSelect(String sYymd,String sCvcod, String sSaupj,
        ...
        String SQL = " SELECT ROWNUM, "
        		...
        		+ "        C.ISPEC, "
        		+ "		   C.JIJIL, "
        		+ "        (A.QTY_01 + A.QTY_02 + A.QTY_03 + A.QTY_04 + A.QTY_05 + A.QTY_06 + A.QTY_07) as sum, "
        		+ "        A.QTY_01 AS D1, "
        		+ "        A.QTY_02 AS D2, "
        		+ "        A.QTY_03 AS D3, "
        		+ "        A.QTY_04 AS D4, "
