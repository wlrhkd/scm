...
<head>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="pln_year_q.css">
    <script type="text/javascript" src="./pln_year_q.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span> 연간 자재 계획 </span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">                                    
                                    ...
                                    <label class="label key ml15 for="toYyyy">계획년도</label>
                                    <div class="cal-input">
                                        <input type="text" class="wt80" name="toYyyy" id="txt_Yyyy" > <!-- name="toDate" id="txt_toDate" -->
                                    </div>
                                    <label class="label key" for="cvcod">업체</label>
                                    <input type="text" class="wt80 center" name="cvcod" id="txt_cvcod">
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    ...
                                    <table class="table-type02 color02" id="tbl_wrap">
                                        <caption>년간 자재 계획 현황 테이블 입니다.</caption>
                                        <thead id="tbl_head">
