...
<head>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="qlt_proqa_e.css">
    <script type="text/javascript" src="./qlt_proqa_e.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span>품질 개선 통보</span></h2>
                            <div class="btn-group">
