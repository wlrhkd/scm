...
<head>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="qlt_yning_q.css">
    <script type="text/javascript" src="./qlt_yning_q.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span>검사 진행 현황</span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">
                                    <label class="label key" for="fromDate">납품일자</label>
                                    <div class="cal-input">
                                    ...
                                    <input type="text" class="wt88" name="cvcod" id="txt_cvcod" placeholder="">
                                ...
                                <div class="row">      
                                    <label class="label label_len" for="saupj">사업장</label>
                                    <select id="sel_saupj" class="wt180">
                                    </select>
                                    <label class="label ml25 itnbr_label" for="itnbr">품번</label>
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    ...
                                    <table class="table-type02 color02" id="tbl_wrap">
                                        <caption>검사 진행 현황 테이블 입니다</caption>
                                        <thead id="tbl_head">
