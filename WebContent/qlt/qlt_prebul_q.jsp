...
<head>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="qlt_prebul_q.css">
    <script type="text/javascript" src="./qlt_prebul_q.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span>불량 현황 내역</span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">
                                    <div class="con-box">
	                                    <label class="label key ml0" for="fromDate">기간</label>
	                                    <div class="cal-input">
	                                        <input type="text" class="wt100 " name="fromDate" id="txt_fromDate">
	                                    </div>
	                                    <span class="period">~</span> 
	                                    <div class="cal-input">
	                                        <input type="text" class="wt100" name="toDate" id="txt_toDate" >
	                                    </div>
