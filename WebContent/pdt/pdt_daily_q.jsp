...
<head>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="pdt_daily_q.css">
    <script type="text/javascript" src="./pdt_daily_q.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span>일일 생산 계획 </span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">                                    
                                    <label class="label key ml0" for="fromDate">계획일자</label>
                                    <div class="cal-input">
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    ...
                                    <table class="table-type02 color02" id="tbl_wrap">
                                        <caption>일일 생산 계획 현황 테이블 입니다.</caption>
                                        <thead id="tbl_head">
