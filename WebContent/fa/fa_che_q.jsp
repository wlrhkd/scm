...
<head>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="fa_che_q.css">
    <script type="text/javascript" src="./fa_che_q.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span> 채권/채무 현황 </span></h2>
                            <div class="btn-group">
...
<!--                                         <caption>채권/채무 현황 테이블 입니다.</caption> -->
                            ...
                            <div class="table-box-wrap type02 righttbl">
                                <div class="table-scroll basic-scroll">
                                    <div   class="container-fluid" >  
                                    <table class="table-type02 color02" id="tbl_wrapS">
                                        <caption>채권/채무 현황 테이블 입니다.</caption>
                                        <thead id="tbl_headS">
