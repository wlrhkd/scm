...
function onSave(e) {
    if (jfUpdateChk(e.target.id)) {
        ...
        $('#tbl_wrap tr:gt(0)').each(function (row, tr) {
            ...
            const vSelectboxes = $(this).find("select").val();
        ...
        success: function (response) {
            ...
            if (aData.RecordCount > 0) {
                ...
                if (vGubun == "I") {
                    ...
                    vListHTML += "<th class='table-contents hidden wt0'>IPDPT</th>";
                    vListHTML += "<th class='table-contents hidden wt0'>CVCOD</th>"
                    vListHTML += "<th class='table-contents hidden wt0'>BALSEQ</th>"
                    vListHTML += "<th class='table-contents hidden wt0'>PSPEC</th>"
                    vListHTML += "<th class='table-contents hidden wt0'>PFILE</th>"
                    vListHTML += "<th class='table-contents hidden wt0'>BALRATE</th>"
                    vListHTML += "<th class='table-contents hidden wt0'>IPSAUPJ</th>"
                } else {
                    vListHTML += "<th><input type='checkbox' name='checkAll' id='checkAll'></th>";
                    vListHTML += "<th>납품처</th>";
                    vListHTML += "<th>납품번호</th>";
                    vListHTML += "<th>품번</th>";
                    vListHTML += "<th>품명</th>";
                    vListHTML += "<th>규격</th>";
                    vListHTML += "<th>재질</th>";
                    vListHTML += "<th>수량</th>";
                    vListHTML += "<th>공장</th>";
                    vListHTML += "<th>입고상태</th>";
                    vListHTML += "<th>발주번호</th>";
                    vListHTML += "<th>순번</th> ";
                    vListHTML += "<th>고객발주번호</th> ";
                    vListHTML += "<th>포장용기</th> ";
                    vListHTML += "<th>용기적입수</th> ";
                    vListHTML += "<th>비고</th> ";
                    vListHTML += "<th class='table-contents hidden'>JPNO</th>"
                }
                vListHTML += "</tr>";
