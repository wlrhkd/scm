...
<head>
    ...
    <!-- 테이블 리사이징 -->
<!--     <script type="text/javascript" src="../comm/js/colResizable-1.6.js"></script> -->
<!--     <script type="text/javascript" src="../comm/js/colResizable-1.6.min.js"></script> -->

    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="ord_segm_e.css">
    <script type="text/javascript" src="./ord_segm_e.js"></script>
    <script type="text/javascript" src="../comm/js/comm_menuList.js"></script>
    <script type="text/javascript" src="../comm/popup/comm_segm_f.js"></script>
...
<body>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span>매출확정/계산서 </span></h2>
                            <div class="btn-group">
                                <jsp:include page="../comm/jsp/comm_btnGroup.jsp"/>                                   
                            </div>                                             
                        </div>
                        <!-- 타이틀 및 버튼 영역 끝 -->
                        <div class="sheet-box-mechul">
                            <!-- 조회조건 영역 시작 -->
                            <div class="form-block" id="wrapHead">
                                <div class="row">
                                    ...
                                    <div class="cal-input">
                                        <input type="text" class="wt120" name="fromDate" id="txt_fromDate">
                                    </div>
                                    <span class="period">~</span>
                                    <div class="cal-input">
                                        <input type="text" class="wt120" name="toDate" id="txt_toDate" >
                                    </div>
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    ...
                                    <table class="table-type02 color02" id="tbl_wrap">
                                        <caption>매출확정/계산서가 발행된 내역을 조회하는 표 입니다.</caption>
                                        <thead id="tbl_head">
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    <div class="container-fluid" >                                    
                                    <table class="table-type02 color02" id="tbl_wrap_bot">
                                        <caption>매출확정/계산서가 발행된 내역을 조회하는 표 입니다.</caption>
                                        <thead id="tbl_head_bot">
                                        	
                                        </thead>
                                        <tbody id="tbl_body_bot">
    ...
    <div class="modal-layer-wrap">
        ...
        <!-- 거래처 팝업 끝 -->
		<!-- 계산서 발행 팝업 시작 -->
		<div id="oSegmListModal" class="modal-layer w1440">
			<jsp:include page="../comm/popup/comm_segm_f.jsp"/>
		</div>        
		<!-- 계산서 발행 팝업 끝 -->
		<!-- 알림창 시작 -->
