...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../comm/popup/ord_balju_f.css">
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="ord_balju_q.css">
    <script type="text/javascript" src="./ord_balju_q.js"></script>
    ...
    <script type="text/javascript" src="../comm/popup/ord_balju_f.js"></script>
    ...
    <script type="text/javascript" src="../comm/js/comm_header.js"></script>  
    <!--  SweetAlert -->
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span>발주현황 </span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">                                    
                                    ...
                                    <label class="label key ml15" for="fromDate">출발일</label>
                                    <div class="cal-input">
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    ...
                                    <table class="table-type02 color02" id="tbl_wrap">
                                        <caption>발주현황 메뉴 테이블입니다.</caption>
                                        <thead id="tbl_head">
