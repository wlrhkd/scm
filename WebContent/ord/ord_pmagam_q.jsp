...
<head>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="ord_pmagam_q.css">
    <script type="text/javascript" src="./ord_pmagam_q.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span> 월 마감 전 현황 </span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">               
                                    ...
                                    <label class="label key" for="toYymm">마감년월</label>
                                    <div class="cal-input">
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    ...
                                    <table class="table-type02 color02" id="tbl_wrap">
                                        <caption>월 마감 전 현황 테이블 입니다.</caption>
                                        <thead id="tbl_head">
