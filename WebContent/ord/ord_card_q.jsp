...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="ord_card_q.css">
    <script type="text/javascript" src="./ord_card_q.js"></script>
...
<body>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span>납입 카드발행 </span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">
                                    <div class="radio-box">               
                                        <div class="radio ml20 np">
                                            <input type="radio" name="gubun" id="rbt_gubun" value="Y" checked>
                                            <label for="radio01">발행</label>
                                            <i></i>
                                        </div>
                                        <div class="radio ml20 np">
                                            <input type="radio" name="gubun" id="rbt_gubun" value="N" >
                                            <label for="radio02">미발행</label>
                                            <i></i>
                                        </div>
                                    </div>
                                    <div class="con-box">
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    ...
                                    <table class="table-type02 color02" id="tbl_wrap">
                                        <caption>납입카드 발행,미발행과 거래명세서 출력을 할 수 있는 테이블 입니다.</caption>
                                        <thead id="tbl_head">
    ...
    <div class="modal-layer-wrap">
        ...
        <!-- 즐겨찾기 팝업 끝-->
		<!-- REPORT -->
<!--        	<div id="oReportModal" class="modal-layer w980"> -->
<%--        		<jsp:include page="../comm/popup/comm_report_f.jsp"/> --%>
<!--        	</div> -->
        <!-- REPORT끝 -->
		<!-- 알림창 시작 -->
