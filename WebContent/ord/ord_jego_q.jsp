...
<head>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="ord_jego_q.css">
    <script type="text/javascript" src="./ord_jego_q.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span>현재고현황 </span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">                                    
                                    ...
                                    <label class="label" for="depot_no">창고</label>
                                    <select id="sel_depot_no" class="wt180">
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    ...
                                    <table class="table-type02 color02" id="tbl_wrap">
                                        <caption>현재고현황 메뉴 테이블입니다.</caption>
                                        <thead id="tbl_head">
