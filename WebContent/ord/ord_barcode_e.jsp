...
<head>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="ord_barcode_e.css">
    <script type="text/javascript" src="./ord_barcode_e.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span> LOT라벨 발행 </span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">               
                                    <label class="label ml13" for="saupj">사업장</label>
                                    <select id="sel_saupj" class="wt180">
                                    
                                    </select>
                                    
                                    <label class="label" for="cvcod">업체</label>
                                    <input type="text" class="center wt88" name="cvcod" id="txt_cvcod" placeholder="">
                                    ...
                                    <label class="label key ml5" for="fromDate">출발일자</label>
                                    <div class="cal-input">
                                    ...
                                    <label class="label" for="jpno">납품번호</label>
                                    <input type="text" class="center wt180" name="cvcod" id="txt_jpno" placeholder="">
                                </div>
                                <div class="row">
                                    ...
                                    <input type="text" class="center wt88" name="itnbr" id="txt_itnbr" placeholder="">
                                	...
                                	<label class="label pl365" for="size">라벨규격</label>
                                    <select id="sel_size" class="wt180">
                                    	<option value="1">100 x 50.8mm(A4)</option>
                                    	<option value="3">100 x 70mm(label)</option>
                                    </select>
                                </div>
                            </div>
                            <!-- 조회조건 영역 끝 -->
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    ...
                                    <table class="table-type02 color02" id="tbl_wrap">
                                        <caption>LOT라벨 발행 테이블 입니다.</caption>
                                        <thead id="tbl_head">
