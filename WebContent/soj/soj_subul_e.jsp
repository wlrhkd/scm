...
<head>
    ...
    <script type="text/javascript" src="..b/comm/js/main.js"></script>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="soj_subul_e.css">
    <script type="text/javascript" src="./soj_subul_e.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span> 사급 요청 등록 </span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">                                    
                                    <label class="label key ml0" for="toYymm">기준년월</label>
                                    <div class="cal-input">
                                        <input type="text" class="wt100" name="toYymm" id="txt_Yymm" > <!-- name="toDate" id="txt_toDate" -->
                                    </div>
                            ...
                            <div class="table-box-wrap type02">
                                <div class="table-scroll basic-scroll">
                                    ...
                                    <table class="table-type02 color02" id="tbl_wrap">
                                        <caption>사급 요청 등록 테이블 입니다.</caption>
                                        <thead id="tbl_head">
