...
<head>
    ...
    <!-- 공통 사용부분 끝 -->
    <link rel="stylesheet" type="text/css" href="soj_sagub_q.css">
    <script type="text/javascript" src="./soj_sagub_q.js"></script>
                ...
                <div class="sheet-wrap">
                    <div class="inner">
                        ...
                        <div class="sub-header">
                            <h2 class="title"><span> 유상 사급 현황 </span></h2>
                            <div class="btn-group">
                        ...
                        <div class="sheet-box">
                            ...
                            <div class="form-block" id="wrapHead">
                                <div class="row">                                    
                                    ...
                                    <label class="label key ml5" for="fromDate">기간</label>
                                    <div class="cal-input">
                                    ...
                                    <label class="label ml10 hidden" for="itnbr">품번</label>
                                    <input type="text" class="wt88 ml15 hidden" name="itnbr" id="txt_itnbr" placeholder="">
                                    <input type="text" name="Itdsc" id="txt_itdsc" class="wt150 hidden">
                                    <button id="btn_itemasModal" class="btn h34 gray non-txt g_search_icon hidden" onclick="modalObj.modalOpenFunc('oItemasModal')"></button>                                                                                                       
                                </div>
                            </div>
                            <!-- 조회조건 영역 끝 -->
                            <!-- 테이블 영역 시작-->  
